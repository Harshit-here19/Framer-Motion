...
import MotionValue from './component/MotionValue';
       ...
       {/* 👇 Radio Button Group - Styled as Pills */}
        <div className="flex flex-wrap justify-center gap-3 my-8">
          {[
            ...
            { id: 'g', label: '🎭 Motion Value' },
          ].map((option) => (
            <label
              key={option.id}
              className={`px-6 py-3 rounded-full   transition-all duration-300 font-medium text-sm sm:text-base ${
                selected === option.id
